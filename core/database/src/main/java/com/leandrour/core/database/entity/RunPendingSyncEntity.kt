...
data class RunPendingSyncEntity(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (mapPictureBytes != null) {
            if (other.mapPictureBytes == null) return false
            if (!mapPictureBytes.contentEquals(other.mapPictureBytes)) return false
        } else if (other.mapPictureBytes != null) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + (mapPictureBytes?.contentHashCode() ?: 0)
